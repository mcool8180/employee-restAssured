...
import static com.briozing.employee.factory.Log4JFactory.*;
...
public class MainUtils {
    ...
    public static String fetchProperty(Properties properties, String key) {
        ...
        try {
            ...
            e.printStackTrace();
            getCommonLogger().info("Properties.fetchProperty : Key not found in property object " + key);
        }
    ...
    public static FileInputStream loadProperties(String propertiesFile) {
        ...
        try {
            ...
            e.printStackTrace();
            getCommonLogger().info("Error while getting file object" + e);
        }
